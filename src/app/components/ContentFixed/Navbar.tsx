      ...
      <div className="w-full flex justify-between items-center mx-5 my-2">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <a className="text-3xl text-cyan-500 font-extrabold font-sf-pro-rounded">
              BASE - {process.env.AQMS_SITE}
            </a>
            <div className="flex flex-row gap-2 align-middle items-center">
              ...
              <a className="font-sf-pro-rounded text-lg text-cyan-500">
                <span className="font-extrabold">
                  {location.lat.toFixed(3)}
                </span>{" "}
                <span className="">&deg;LU</span>
              </a>
              <a className="font-sf-pro-rounded text-lg text-cyan-500">,</a>
              <a className="font-sf-pro-rounded text-lg text-cyan-500">
                <span className="font-extrabold">
        ...
        <div className="flex gap-5 items-center">
          <ul className="menu menu-horizontal px-1 items-center gap-2 z-10">
            <li>
              <details>
                <summary className="font-sf-pro-rounded font-bold text-2xl text-cyan-500">
                  Menu
                </summary>
                <ul className="bg-zinc-800 rounded-t-none p-2">
            ...
            <li className="flex flex-row items-center gap-4">
              ...
              <div
                tabIndex={0}
                role="button"
                className="btn btn-ghost btn-circle text-cyan-500 text-5xl"
              >
                {isOnline ? (
